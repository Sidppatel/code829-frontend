...
const routes: RouteConfig[] = [
  ...
  { path: 'reset-password', loader: () => import('./pages/reset-password/ResetPasswordPage') },
  {
    ...
    children: [
      ...
      { path: 'performers/new', loader: () => import('./pages/performers/PerformerEditPage') },
      { path: 'performers/:id', loader: () => import('./pages/performers/PerformerEditPage') },
      { path: 'sponsors', loader: () => import('./pages/sponsors/SponsorsListPage') },
      { path: 'sponsors/new', loader: () => import('./pages/sponsors/SponsorEditPage') },
      { path: 'sponsors/:id', loader: () => import('./pages/sponsors/SponsorEditPage') },
